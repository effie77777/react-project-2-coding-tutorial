            ...
            <section className="my-11">
                <form>
                    <div className="mb-6">
                        ...
                        <input type="text" className="form-control p-3" id="username" name="username" required onChange={changeUsername} />
                    </div>
                    <div className="mb-6">
                        <label htmlFor="email" className="form-label">信箱</label>
                        <input type="email" className="form-control p-3" id="email" name="email" placeholder="example@gmail.com" required onChange={changeEmail} />
                    </div>
                    <div className="mb-11">
                        <div className="position-relative">
                            <label htmlFor="password" className="form-label">密碼</label>
                            <input type="password" className="form-control py-3 ps-3" id="password" name="password" minLength="8" required style={{paddingRight: "3.5rem"}} onChange={changePassword}
                    ...
                    <button type="submit" className="btn bg-linear text-white px-6 w-100 w-sm-40 w-md-30 w-lg-25 border-0" style={{paddingTop: "0.625rem", paddingBottom: "0.625rem"}} onClick={handleRegister}>註冊</button>
                </form>
            </section>
        </div>
    )
